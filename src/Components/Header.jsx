    ...
    <div className='bg-black p-4 '>
        <div className='max-w-[1240px] p-[15px] items-center  mx-auto flex justify-between'>
           <div className='text-3xl font-bold text-white '>REACT.</div>
           {
            ...
            {/* Responsive */}
           <div className={`md:hidden fixed top-[15.7%] w-[60%] h-full border-r border-r-grey-900 bg-gray-400 text-white 
            ...
            <ul className='uppercase'>
              ...
              <li className='m-6 p-4 border-b border-b-gray-800'>Contact </li>
            </ul>
            </div>
        </div>
    </div>
